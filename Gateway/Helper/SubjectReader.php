 ...
 */
namespace Setor7\Cielo\Gateway\Helper;
...
class SubjectReader
{
    ...
    public function readTransaction(array $subject)
    {
        ...
        if (!isset($subject['object'])
            && !$subject['object'] instanceof CieloEcommerce
        ) {
            throw new \InvalidArgumentException('The object is not a class \Ecommerce\CieloEcommerce.');
        }
